...
begin
  ...
  self._data.strict_sace:=FZConfigMgr.Get.GetBool('strict_sace', false);
  ...
  //GUI options
  self._data.gui_chat_direction:=FZConfigMgr.Get.GetInt('gui_chat_direction', 0);
end;
